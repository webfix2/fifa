...
const TRAINING_EXAMPLES = [
  {
    ...
    description: 'Witness the FIFA World Cup 2026 Final live at MetLife Stadium. The biggest match in football.',
    coverImage: '',
    terms: '',
  },
  {
    ...
    category: 'Football',
    ageRestriction: 'All Ages',
    description: 'Semi-final match of the FIFA World Cup 2026 at AT&T Stadium in Arlington.',
    coverImage: '',
    terms: '',
  },
  {
