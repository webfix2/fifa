    ...
    return (
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <main className="flex-grow flex flex-col md:flex-row overflow-y-auto">
                {/* Left Column (Sidebar) */}
                <div className="hidden md:flex md:w-[45%] bg-[#002B7F] flex-col justify-between p-12 text-white relative overflow-hidden">
                    <div className="z-10">
                    ...
                    <div className="z-10 flex items-center">
                        <svg xmlns="https://lh3.googleusercontent.com/a-/ALV-UjXmI_R6mr2s1KnPXx7t5KhgAe9drmgY8So16bDQ9clqysQp-jQ=s300-p-k-rw-no" width="120" height="16" viewBox="0 0 160 25" className="opacity-80">
                ...
                <div className="flex-1 flex flex-col justify-start md:justify-center px-8 md:px-20 lg:px-32 xl:px-48 py-20 overflow-y-auto">
                    <div className="max-w-[480px] w-full mx-auto">
                        ...
                        {tokenLoggingIn && (
                            <div className="bg-blue-50 text-[#002B7F] p-6 rounded-lg mb-6 border border-blue-100 flex items-center justify-center space-x-3">
                        ...
                        <form onSubmit={handleLogin} className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 border border-gray-300 rounded-md focus:border-[#002B7F] focus:ring-1 focus:ring-[#002B7F] outline-none transition-all text-[16px] text-[#1F262D]"
                                    required
                                />
                            </div>
                            ...
                            <button
                                type="submit"
                                className="w-full bg-[#002B7F] text-white py-4 rounded-full font-bold text-[16px] hover:bg-[#0256B3] transition-all shadow-md active:scale-[0.99] disabled:opacity-50"
                                disabled={loading}
                            >
                        ...
                        <button className="w-full mt-4 text-[#002B7F] font-bold text-[14px] hover:underline">
                        ...
                        <div className="mt-12 text-[12px] text-gray-500 leading-relaxed">
                            <p>
                                ...
                                <a href="#" className="text-[#002B7F] hover:underline">Terms of Use</a>, including the arbitration agreement and class action waiver, updated in August 2025, and understand that information will be used as described in our{' '}
                                <a href="#" className="text-[#002B7F] hover:underline">Privacy Policy</a>.
                            </p>
                            <p className="mt-4">
