                        ...
                        <form onSubmit={handleLogin} className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 border border-gray-300 rounded-md focus:border-[#026CDF] focus:ring-1 focus:ring-[#026CDF] outline-none transition-all text-[16px] text-[#1F262D]"
                                    required
                                />
                            </div>
